...
def main(argv):
    ...
    plot_hist([hist_trk_pt_b, hist_trk_pt_btoc, hist_trk_pt_c, hist_trk_pt_nohf], ["bH", "bH->cH", "prompt cH", "no HF"], True, False, True, data_path+data_name+"_trk_pt.png", "HIST", scaling=[mean_features[0],std_features[0]])
    plot_hist([hist_trk_theta_b, hist_trk_theta_btoc, hist_trk_theta_c, hist_trk_theta_nohf], ["bH", "bH->cH", "prompt cH", "no HF"], True, False, True, data_path+data_name+"_trk_theta.png", "HIST", scaling=[mean_features[1],std_features[1]])
    plot_hist([hist_trk_phi_b, hist_trk_phi_btoc, hist_trk_phi_c, hist_trk_phi_nohf], ["bH", "bH->cH", "prompt cH", "no HF"], True, False, True, data_path+data_name+"_trk_phi.png", "HIST", scaling=[mean_features[2],std_features[2]])
    plot_hist([hist_trk_d0_b, hist_trk_d0_btoc, hist_trk_d0_c, hist_trk_d0_nohf], ["bH", "bH->cH", "prompt cH", "no HF"], True, False, True, data_path+data_name+"_trk_d0.png", "HIST", scaling=[mean_features[3],std_features[3]])
    plot_hist([hist_trk_z0_b, hist_trk_z0_btoc, hist_trk_z0_c, hist_trk_z0_nohf], ["bH", "bH->cH", "prompt cH", "no HF"], True, False, True, data_path+data_name+"_trk_z0.png", "HIST", scaling=[mean_features[4],std_features[4]])
    ...
    plot_profile([prof_frac_reco_pt_b, prof_frac_reco_pt_c], ["b", "c"], [0.0, 1.4], False, data_path+data_name+"_frac_reco_pt.png")
    ...
    plot_hist([hist_acc_trk_pt_hf, hist_rej_trk_pt_hf], ["passed", "cut"], False, True, True, data_path+data_name+"_cut_trk_pt_hf.png", "HIST")
    plot_hist([hist_acc_trk_pt_nohf, hist_rej_trk_pt_nohf], ["passed", "cut"], False, True, True, data_path+data_name+"_cut_trk_pt_nohf.png", "HIST")
    plot_hist([hist_acc_trk_z0_hf, hist_rej_trk_z0_hf], ["passed", "cut"], False, True, True, data_path+data_name+"_cut_trk_z0_hf.png", "HIST")
    plot_hist([hist_acc_trk_z0_nohf, hist_rej_trk_z0_nohf], ["passed", "cut"], False, True, True, data_path+data_name+"_cut_trk_z0_nohf.png", "HIST")
