...
def main(argv):
    ...
    hist_vertex_lxy_b = TH1D("vertex_lxy_b", "Vertex Lxy in dataset;Lxy [mm];Normalized entries", 20, 0, 200)
    hist_vertex_lxy_c = TH1D("vertex_lxy_c", "Vertex Lxy in dataset;Lxy [mm];Normalized entries", 20, 0, 200)
