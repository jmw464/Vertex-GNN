...
NTUPLES="user.jmwagner.27266824.Akt4EMPf_BTagging201903._000003"
...
do
	...
	python scripts/process_ntuple.py -n ${NTUPLE} -i ${DATADIR} -o ${DATADIR} -e ${MAX_EVENTS} -v ${EVENTS_PER_FILE}
	printf "\n"
done
